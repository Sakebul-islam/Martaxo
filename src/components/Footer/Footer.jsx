  ...
  return (
    <footer className='flex flex-col items-center bg-neutral-200 text-center text-white dark:bg-gray-300'>
        ...
        <div className='mb-9 gap-6 sm:gap-0 flex flex-col sm:flex-row justify-center items-center sm:justify-between'>
          ...
          <div className='gap-5 flex justify-center'>
            <Link
              ...
              target='_blank'
              className='text-neutral-800 dark:text-neutral-800 p-2 sm:p-3 border-2 border-neutral-600 bg-neutral-300 drop-shadow-xl hover:bg-[#db874f33] hover:border-orange-500 duration-200 hover:text-black'
            >
              <svg
      ...
      <div className='w-full bg-neutral-300 p-4 text-center text-neutral-700 dark:bg-neutral-700 dark:text-neutral-200'>
        All content on this website is protected by copyright © 2023
        <Link to='/' className='text-neutral-800 dark:text-neutral-400'>
          <span className='ml-1'>MARTAXO</span>
        </Link>
      </div>
    </footer>
  );
